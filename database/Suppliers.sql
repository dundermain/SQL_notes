...
SupplierID	SupplierName	ContactName	Address	City	PostalCode	Country	Phone VARCHAR( 100 )
);

/* INSERT QUERY */
INSERT INTO TABLE_NAME( SupplierID	SupplierName	ContactName	Address	City	PostalCode	Country	Phone )
VALUES
(
